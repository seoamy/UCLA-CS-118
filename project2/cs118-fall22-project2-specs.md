...
To run any of the code in this project, you will need a computer running Linux. We have specifically tested the code on Ubuntu 22.04, but it is likely
...
to work on most Linux distributions, provided you install the dependencies correctly. If your machine does not run Linux natively, you have two options.
